...
FILE = f'KMP_{DAY}{MONTH}_{HOUR}{MIN}.xlsx'

TITLE = "1m 3f 219y Bet At racingtv.com Classified Stakes (Div 2)"
...
<body>
    <div class="all">
        <div class="header1">
            <div class="race-logo"><img src="Kempton.png" alt="Kempton Logo" style="width:180px;height:90px;">
            </div>
    ...
    <div class="lower-banner">
        ...
        <div class="email" style="text-align:right;"><a href="mailto:sectionals@racinguk.tv">sectionals@racinguk.tv</a>
        </div>
    </div>
</div>
</body>
